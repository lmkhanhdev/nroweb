...
const MidrangeDetails = () => {
    const {id} = useParams()

    const midrange = midranges.find(midrange => midrange.id === id)
            ...
            <Col lg='12'>
              <div className="acc__details">
                ...
                <div className="details__describe">
                  ...
                  <span className='describe__title describe__list'>Nổi Bật: <span>{noibat}</span></span>
                </div>
                <div className='details__img'>
                  ...
                  {imgs.map((img, index) => (
                    <div className="images__item" key={index}>
                      ...
                      <img src={img.img07} alt="" />
                      <img src={img.img08} alt="" />
                      <img src={img.img09} alt="" />
...
export default MidrangeDetails